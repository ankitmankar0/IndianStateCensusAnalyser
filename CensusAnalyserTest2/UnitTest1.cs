...
namespace CensusAnalyserTest
{
    public class Tests
    {
        ...
        static string indianStateCensusFilePath = @"C:\Users\ankit\Desktop\bridgelab\.Net\Workshop\IndianStateCensusAnalyser\CensusAnalyserTest2\CSVFiles\IndiaStateCensusData.csv";
        static string wrongHeaderIndianCensusFilePath = @"C:\Users\ankit\Desktop\bridgelab\.Net\Workshop\IndianStateCensusAnalyser\CensusAnalyserTest2\CSVFiles\WrongIndiaStateCensusData.csv";
        static string delimiterIndianCensusFilePath = @"C:\Users\ankit\Desktop\bridgelab\.Net\Workshop\IndianStateCensusAnalyser\CensusAnalyserTest2\CSVFiles\DelimiterIndiaStateCensusData.csv";
        ...
        static string wrongIndianStateCensusFileType = @"C:\Users\ankit\Desktop\bridgelab\.Net\Workshop\IndianStateCensusAnalyser\CensusAnalyserTest2\CSVFiles\IndiaStateCensusData.txt";
        static string indianStateCodeFilePath = @"C:\Users\ankit\Desktop\bridgelab\.Net\Workshop\IndianStateCensusAnalyser\CensusAnalyserTest2\CSVFiles\IndiaStateCode.csv";
        static string wrongIndianStateCodeFileType = @"C:\Users\ankit\Desktop\bridgelab\.Net\Workshop\IndianStateCensusAnalyser\CensusAnalyserTest2\CSVFiles\IndiaStateCode.txt";
        static string delimiterIndianStateCodeFilePath = @"C:\Users\ankit\Desktop\bridgelab\.Net\Workshop\IndianStateCensusAnalyser\CensusAnalyserTest2\CSVFiles\DelimiterIndiaStateCode.csv";
        static string wrongHeaderStateCodeFilePath = @"C:\Users\ankit\Desktop\bridgelab\.Net\Workshop\IndianStateCensusAnalyser\CensusAnalyserTest2\CSVFiles\WrongIndiaStateCode.csv";
